...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $dbServerNameParam $maDBNameParam $refDBNameParam $refDBAppUserNameParam $refDBAppUserPwdParam $maDBAppUserNameParam $maDBAppUserPwdParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $licenseParam $maDBApplicationConnectionStringParam $refDBApplicationConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $allowInvalidClientCertiAppSettingParam $xpPerformanceCounterParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
