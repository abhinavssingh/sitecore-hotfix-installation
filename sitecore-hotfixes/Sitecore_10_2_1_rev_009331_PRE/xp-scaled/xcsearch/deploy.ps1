...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $collectionSearchServiceUrlParam $collectionSearchIndexNameParam $collectionSearchQueryApiKeyParam $collectionSearchWorkerApiKeyParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xpPerformanceCounterParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $licenseParam $collectionSearchQueryAppConnectionStringlParam $collectionSearchWorkerAppConnectionStringlParam $messagingConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $xcServerNameAppSettingParam $allowInvalidClientCertiAppSettingParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
