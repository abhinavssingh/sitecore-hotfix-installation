...
$xdbRefDataParam = "-setParam:name=`"Reference Data Connection String`",value=`"notUsed`""
...
$redisSessionParam = "-setParam:name=`"Redis Sessions`",value=`"notUsed`""
...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $securityParam $webParam $xdbRefDataParam $expFormsParam $exmMasterParam $applicationInsightRoleParam $searchParam $solrParam $messagingParam $applicationInsightsParam $sitecoreCountersParam $aiParam $redisSessionParam $xconnectParam $xdbRefDataClientParam $xdbMAReportingClientParam $xdbMAOpsClientParam $xcCollectionCertiParam $xdbRefdataClientCertiParam $xdbMAOpsClientCertiParam $exmCryptographicKeyParam $exmAuthenticationKeyParam $allowInavalidClientCertiParam $licenseParam $siAuthorityParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
