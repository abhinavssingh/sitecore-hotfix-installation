...
$collectionShard0DBNameParam = "-setParam:name=`"Collection Shard 0 Database Name`",value=`"notUsed`""
$collectionShard1DBNameParam = "-setParam:name=`"Collection Shard 1 Database Name`",value=`"notUsed`""
...
$refDBConnectionStringParam = "-setParam:name=`"Reference Data Database Connection String`",value=`"notUsed`""
...
$prcPoolDBConnectionStringParam = "-setParam:name=`"Processing Pool Database Connection String`",value=`"notUsed`""
$maDBConnectionStringParam = "-setParam:name=`"Marketing Automation Database Connection String`",value=`"notUsed`""
...
$collectionShard0DBConnectionStringParam = "-setParam:name=`"Collection Shard 0 Database Connection String`",value=`"notUsed`""
$collectionShard1DBConnectionStringParam = "-setParam:name=`"Collection Shard 1 Database Connection String`",value=`"notUsed`""
...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $dbServerNameParam $dbAdminUserNameParam $dbAdminPasswordParam $collectionDBServerNameParam $collectionShardDBNameParam $collectionShard0DBNameParam $collectionShard1DBNameParam $prcPoolDBNameParam $maDBNameParam $collectionlDBAppUserNameParam $collectionDBAppUserPwdParam $refDBNameParam $refDBAppUserNameParam $refDBAppUserPwdParam $refDBConnectionStringParam $refDBApplicationConnectionStringParam $prcPoolDBAppUserNameParam $prcPoolDBAppUserPwdParam $maDBAppUserNameParam $maDBAppUserPwdParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xpPerformanceCounterParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $licenseParam $prcPoolDBConnectionStringParam $maDBConnectionStringParam $collectionShardDBConnectionStringParam $collectionShard0DBConnectionStringParam $collectionShard1DBConnectionStringParam $prcPoolDBApplicationConnectionStringParam $maDBApplicationConnectionStringParam $messagingConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $xcServerNameAppSettingParam $allowInvalidClientCertiAppSettingParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
