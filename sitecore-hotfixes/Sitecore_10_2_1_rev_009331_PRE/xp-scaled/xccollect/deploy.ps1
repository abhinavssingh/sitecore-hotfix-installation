...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xpPerformanceCounterParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $licenseParam $messagingConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $xcServerNameAppSettingParam $allowInvalidClientCertiAppSettingParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
