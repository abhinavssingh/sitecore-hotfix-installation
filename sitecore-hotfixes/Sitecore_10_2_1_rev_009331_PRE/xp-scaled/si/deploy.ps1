...
$allowedCorsOriginParam = "-setParam:name=`"AllowedCorsOrigins`",value=`"notUsed`""
$ClientSecretParam = "-setParam:name=`"ClientSecret`",value=`"notUsed`""
$securityConnectionStringParam = "-setParam:name=`"Security Connection String`",value=`"notUsed`""
$passwordRecoveryUrlParam = "-setParam:name=`"PasswordRecoveryUrl`",value=`"notUsed`""
$certificateThumbprintParam = "-setParam:name=`"CertificateThumbprint`",value=`"notUsed`""
$certificateStoreLocationParam = "-setParam:name=`"CertificateStoreLocation`",value=`"notUsed`""
$certificateStoreNameParam = "-setParam:name=`"CertificateStoreName`",value=`"notUsed`""
$AIInstrumentationKeyParam = "-setParam:name=`"Application Insights Instrumentation Key`",value=`"notUsed`""
...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $allowedCorsOriginParam $ClientSecretParam $securityConnectionStringParam $passwordRecoveryUrlParam $certificateThumbprintParam $certificateStoreLocationParam $certificateStoreNameParam $AIInstrumentationKeyParam $licenseParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
