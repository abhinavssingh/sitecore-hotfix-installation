...
$collectionDBAppUserNameParam = "-setParam:name=`"Collection Database Application User Name`",value=`"notUsed`""
...
$xcServerLogLevelParam = "-setParam:name=`"Marketing Automation Engine Xconnect Search Client Endpoint`",value=`"notUsed`""
...
$maEngineXCCollectClientEndpointParam = "-setParam:name=`"Marketing Automation Engine Xconnect Collection Client Endpoint`",value=`"notUsed`""
$maEngineXCCollectClientCertiParam = "-setParam:name=`"Marketing Automation Engine Xconnect Collection Client Certificate Thumbprint`",value=`"notUsed`""
$maEngineXCSearchClientEndpointParam = "-setParam:name=`"Marketing Automation Engine Xconnect Search Client Endpoint`",value=`"notUsed`""
$maEngineXCSearchClientCertiParam = "-setParam:name=`"Marketing Automation Engine Xconnect Search Client Certificate Thumbprint`",value=`"notUsed`""
$maEngineXDBRefDataClientEndpointParam = "-setParam:name=`"Marketing Automation Engine Xdb Reference Data Endpoint`",value=`"notUsed`""
$maEngineXDBRefDataClientCertiParam = "-setParam:name=`"Marketing Automation Engine Xdb Reference Data Client Certificate Thumbprint`",value=`"notUsed`""
$licenseParam = "-setParam:name=`"License Xml`",value=`"notUsed`""
$collectionShardDBApplicationConnectionStringParam = "-setParam:name=`"Collection Shard Map Manager Database Application Connection String`",value=`"notUsed`""
...
$refDBApplicationConnectionStringParam = "-setParam:name=`"Reference Data Database Application Connection String`",value=`"notUsed`""
...
$maEngineXCCollectClientEndpointConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xconnect Collection Client Endpoint Connection String`",value=`"notUsed`""
$maEngineXCCollectClientCertiConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xconnect Collection Client Certificate Connection String`",value=`"notUsed`""
$maEngineXCSearchClientEndpointConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xconnect Search Client Endpoint Connection String`",value=`"notUsed`""
$maEngineXCSearchClientCertiConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xconnect Search Client Certificate Connection String`",value=`"notUsed`""
$maEngineXDBRefDataClientEndpointConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xdb Reference Data Client Endpoint Connection String`",value=`"notUsed`""
$prcEngineXDBRefDataClientCertiConnectionStringParam = "-setParam:name=`"Marketing Automation Engine Xdb Reference Data Client Certificate Connection String`",value=`"notUsed`""
...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $dbServerNameParam $dbAdminUserNameParam $dbAdminPasswordParam $collectionDBServerNameParam $collectionShardDBNameParam $collectionDBAppUserNameParam $collectionDBAppUserPwdParam $prcPoolDBNameParam $maDBNameParam $refDBNameParam $prcPoolDBAppUserNameParam $prcPoolDBAppUserPwdParam $refDBAppUserNameParam $maDBAppUserNameParam $maDBAppUserPwdParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $maEngineXCCollectClientEndpointParam $maEngineXCCollectClientCertiParam $maEngineXCSearchClientEndpointParam $maEngineXCSearchClientCertiParam $maEngineXDBRefDataClientEndpointParam $maEngineXDBRefDataClientCertiParam $licenseParam $collectionShardDBApplicationConnectionStringParam $prcPoolDBApplicationConnectionStringParam $maDBApplicationConnectionStringParam $messagingConnectionStringParam $refDBApplicationConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $xcServerNameAppSettingParam $allowInvalidClientCertiAppSettingParam $maEngineXCCollectClientEndpointConnectionStringParam $maEngineXCCollectClientCertiConnectionStringParam $maEngineXCSearchClientEndpointConnectionStringParam $maEngineXCSearchClientCertiConnectionStringParam $maEngineXDBRefDataClientEndpointConnectionStringParam $prcEngineXDBRefDataClientCertiConnectionStringParam $xpPerformanceCounterParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
