...
Invoke-Expression "& '$MsDeployPath' --% $verb $source $dest $iisWebAppParam $dbServerNameParam $dbAdminUserNameParam $dbAdminPasswordParam $collectionDBServerNameParam $collectionShardDBNameParam $collectionDBAppUserNameParam $collectionDBAppUserPwdParam $maDBNameParam $refDBNameParam $refDBAppUserNameParam $maDBAppUserNameParam $maDBAppUserPwdParam $xcServerConfigEnvParam $xcServerCertiParam $xcServerLogLevelParam $xcServerAIKeyParam $xcServerNameParam $allowInvalidClientCertiParam $maEngineXCCollectClientEndpointParam $maEngineXCCollectClientCertiParam $maEngineXCSearchClientEndpointParam $maEngineXCSearchClientCertiParam $maEngineXDBRefDataClientEndpointParam $maEngineXDBRefDataClientCertiParam $licenseParam $collectionShardDBApplicationConnectionStringParam $maDBApplicationConnectionStringParam $messagingConnectionStringParam $refDBApplicationConnectionStringParam $xcServerConfigEnvAppSettingParam $xcServerCertiAppSettingParam $xcServerLogLevelAppSettingParam $xcServerAIKeyAppSettingParam $xcServerNameAppSettingParam $allowInvalidClientCertiAppSettingParam $maEngineXCCollectClientEndpointConnectionStringParam $maEngineXCCollectClientCertiConnectionStringParam $maEngineXCSearchClientEndpointConnectionStringParam $maEngineXCSearchClientCertiConnectionStringParam $maEngineXDBRefDataClientEndpointConnectionStringParam $prcEngineXDBRefDataClientCertiConnectionStringParam $xpPerformanceCounterParam $doNotDeleteRule $appOfflineRule $retryAttemptsParam $retryIntervalParam $verboseParam"
